...
const { query } = require('express'); // this will save the query part of the return
...
app.get('/'/* path or url '/' represrnts route of the website*/, 
...
// });
 ...
 // we can add query 
 // http://localhost:3000/api/posts/2021/5
 //app.get('/api/posts/?sort=name', (req, res) => {
 //    res.send(req.query)
 //    res.send(req.params);  
 //});
